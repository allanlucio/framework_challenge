...
// in framework_challenge/test/features/fruit_shop/domain/usecases/search_products/search_product_usecase_impl_test.dart.
...
class MockProductRepository extends _i1.Mock implements _i3.ProductRepository {
  ...
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.ProductEntity>>> searchProducts(
          {String? query}) =>
      (super.noSuchMethod(
          Invocation.method(#searchProducts, [], {#query: query}),
          returnValue:
